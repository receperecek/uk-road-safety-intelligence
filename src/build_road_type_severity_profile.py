...
work = df[df["road_type"].notna()].copy()

road_type_profile = (
    work.groupby("road_type", dropna=False)
    .agg(
...
road_type_profile.to_csv(tables / "road_type_severity_profile_v1.csv", index=False)

print("road_type_severity_profile_v1_created")
