...
work = df[df["urban_or_rural_area_label"].notna()].copy()

profile = (
    work.groupby("urban_or_rural_area_label", dropna=False)
    .agg(
...
profile.to_csv(tables / "urban_rural_severity_profile_decoded_v1.csv", index=False)

print("urban_rural_severity_profile_decoded_v1_created")
